...
if(isset($_POST['submit'])) {
	...
	if(!isset($hasError)) {
		$emailTo = 'aritse23@gmail.com'; // Put your own email address here
		$body = "Name: $name \n\nEmail: $email \n\nPhone Number: $phone \n\nSubject: $subject \n\nComments:\n $comments";
...
<html lang="en">
  <head>
    ...
    <![endif]-->
  	...
  	<body>
  		<div class="col-xs-offset-1 col-xs-10 col-sm-offset-1 col-sm-5 col-md-offset-1 col-md-5">
			<h1>CAN I HAVE YOUR NUMBA???</h1>
			<!-- FORM STARTS HERE -->
